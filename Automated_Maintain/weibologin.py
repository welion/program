...
class weiboLogin:
    ...
    def getServerData(self):
            url = 'http://login.sina.com.cn/sso/prelogin.php?entry=weibo&callback=sinaSSOController.preloginCallBack&su=&rsakt=mod&client=ssologin.js(v1.4.18)&_=1448609846942'
    ...
    def login(self,username,psw):
           ...
           # print text
            ...
            #访问主页，把主页写入到文件中
            url = 'http://weibo.com/u/2635731574/home?wvr=5'
...
username = 'zhongwanhua@gmail.com'
password = 'zwh123@sina'
#print type(s)
#print username
